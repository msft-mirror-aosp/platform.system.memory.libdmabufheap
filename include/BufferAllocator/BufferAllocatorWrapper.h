...
[[deprecated("Use DmabufHeapAlloc2. ION is not supported. Do not provide ION arguments.")]]
...
int MapDmabufHeapNameToIonHeap(BufferAllocator*, const char*, const char*, unsigned int,
